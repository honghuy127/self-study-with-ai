...
name: summarizer
description: >-
  Reads one source and produces a structured, anchored note in notes/. Use once
  per registry source during the summarizing stage.
