...
anchors re-verified against the pinned commits. Part II asks what
...
\begin{itemize}
  ...
  Sections~\ref{sec:turnloop} to~\ref{sec:safety});
...
before any full extraction (EXP-PLAN-2026-08-19-v1): E1 turn loops, E2
