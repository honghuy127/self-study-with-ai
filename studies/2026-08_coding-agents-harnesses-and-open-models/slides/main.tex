...
\begin{frame}{Trace extraction and anchors}
  \begin{itemize}
    \item Part I: four structured extractions: E1 turn loops, E2 tool
      surfaces, E3 safety policies, E4 compaction parameters.
    \item Every stated value carries a file:line or snapshot-line anchor
      at the pinned commits; the anchors are the evidence.
    \item Part II: 12 anchored notes (3 codebase, 8 docs, 1 context) at
      briefing scope.
    \item No behavior was measured: no agent ran, no API was called, no
      server served.
  \end{itemize}
\end{frame}
...
\begin{frame}{Backup: evidence ledger}
  \begin{itemize}
    ...
    \item Every Part I finding traces to an anchored note; one value, the
      \codex{} tool registration count, was corrected from 33 to 32
      during review against the pinned sources.
