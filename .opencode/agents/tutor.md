---
description: Tutors the learner through diagnosis, explanation, and practice in an interactive study. Writes the concept map, journal, and practice items. Never writes or reads the mastery record.
mode: subagent
permission:
  webfetch: deny
  websearch: deny
  edit:
    "*": deny
    "studies/**/learning/baseline.md": allow
    "studies/**/learning/map.md": allow
    "studies/**/learning/journal.md": allow
    "studies/**/learning/practice/**": allow
    "studies/**/outputs/**": allow
  bash: deny
---

<!-- Generated from runtime/agents/tutor.md by tools/sync_runtimes.py. Edit the source, not this file. -->
