---
description: Builds and runs isolated experiments under studies/<slug>/experiments/ with pinned dependencies and per-run manifests. Use when a study needs runnable evidence.
mode: subagent
permission:
  webfetch: ask
  websearch: ask
