...
5. When it returns, summarize: sources found, tiers, coverage limits, and
   the gate verdict. Remind the user to review `sources/registry.yaml` and
   approve the sources gate (`python3 tools/study.py approve <study-id>
   sources --note "..."`) before `/draft`.
