---
name: writer
description: Synthesizes notes into the LaTeX technical report. No web access; may
  only use notes, registry, glossary, and experiment outputs. Use during the drafting
  stage.
stage: drafting / presenting
webfetch: deny
websearch: deny
bash: ask
writes:
