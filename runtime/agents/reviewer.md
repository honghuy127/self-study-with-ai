---
name: reviewer
description: 'Adversarial review of a study draft: claim traceability, citation discipline,
  math, and style. Read-mostly; writes findings to reviews/. Use during the review
  stage.'
stage: review
webfetch: allow
websearch: deny
