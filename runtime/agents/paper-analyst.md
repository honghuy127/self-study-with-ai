---
name: paper-analyst
description: Produces the comprehensive, anchored analysis of the single target paper
  in a paper-reading study. No web access; writes only notes/_paper-analysis.md.
stage: analyzing
webfetch: deny
websearch: deny
bash: deny
