---
name: researcher
description: Gathers sources for a study brief into sources/registry.yaml with verified
  metadata. Use during the gathering stage.
stage: gathering
webfetch: allow
websearch: allow
bash: ask
writes:
- studies/**/sources/**
- studies/**/.research/evidence.jsonl
