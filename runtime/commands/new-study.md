---
name: new-study
description: 'Scaffold a new study directory from a topic. Usage: /new-study <topic-slug>
  [title] --mode interactive|delegated|paper-reading'
---
...
1. Parse a lowercase-hyphen slug, an optional human-readable title, and a
   ...
   `paper-reading` means agents analyze one exact target paper and return a
   comprehensive, reviewed presentation.
