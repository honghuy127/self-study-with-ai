---
name: draft
description: 'Advance a delegated study one gated step: summarize unnoted sources,
  run experiments on experimental methodologies, then draft the report. Idempotent;
  stops at each human gate. Usage: /draft studies/<slug>'
---
